...
## GitHub ve Vercel ile Iliski

Local calisma asil veri ortamidir. `workspace/workshop-brain`, `.env.local`, `.obsidian`, `.next` ve `node_modules` GitHub'a veya Vercel'e gonderilmez.

Vercel deploy'lari arayuzu ve branch preview'larini kontrol etmek icindir. Vercel'de yerel belgelerin gorunmemesi normaldir.

Gunluk kullanimda asil adres:
